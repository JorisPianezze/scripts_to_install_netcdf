...
./configure --disable-shared               \
            ...
            CC="cc" CFLAGS="-hcpu=x86-64 -gdwarf-4"
make
make install
make clean
...
./configure --enable-fortran                                             \
            ...
            CC="cc" CFLAGS="-hcpu=x86-64 -gdwarf-4"                      \
	    FC="ftn" FCFLAGS="-hcpu=x86-64 -gdwarf-4"                    \
...
./configure --disable-shared \
            ...
            --libdir=${dir_to_install}/lib \
            CC="cc" CFLAGS="-hcpu=x86-64 -gdwarf-4" \
	    FC="ftn" FCFLAGS="-hcpu=x86-64 -gdwarf-4 -emf" FFLAGS="-hcpu=x86-64 -gdwarf-4"  \
            CPPFLAGS="-I${dir_to_install}/include" \
            LDFLAGS="-L${dir_to_install}/lib" \
